...
<html lang="en">
  ...
  <meta charset="UTF-8" />
    ...
    <link
      rel="stylesheet"
      href="./frontend/vendors/liquid-icon/lqd-essentials/lqd-essentials.min.css"
    />
    <link rel="stylesheet" href="./frontend/css/theme.min.css" />
    <link rel="stylesheet" href="./frontend/css/utility.min.css" />
    <link rel="stylesheet" href="./frontend/css/demo/digital-hub/base.css" />
    <link
      rel="stylesheet"
      href="./frontend/css/demo/digital-hub/digital-hub.css"
    />
  ...
  >
    <div id="wrap">
        ...
        >
            <section
                class="lqd-section border-bottom border-white-30 px-25 md:hidden module-header"
                style="background:rgb(85, 91, 141);"
            >
    ...
    <script src="./frontend/vendors/fastdom/fastdom.min.js"></script>
    <script src="./frontend/vendors/fresco/js/fresco.js"></script>
    <script src="./frontend/vendors/lity/lity.min.js"></script>
    <script src="./frontend/vendors/gsap/minified/gsap.min.js"></script>
    <script src="./frontend/vendors/gsap/utils/CustomEase.min.js"></script>
    <script src="./frontend/vendors/gsap/minified/DrawSVGPlugin.min.js"></script>
    <script src="./frontend/vendors/gsap/utils/SplitText.min.js"></script>
    <script src="./frontend/vendors/gsap/minified/ScrollTrigger.min.js"></script>
    <script src="./frontend/vendors/draggabilly.pkgd.min.js"></script>
    <script src="./frontend/vendors/draw-shape/liquidDrawShape.min.js"></script>
    <script src="./frontend/vendors/animated-blob/liquidAnimatedBlob.min.js"></script>
    <script src="./frontend/vendors/fontfaceobserver.js"></script>
    <script src="./frontend/vendors/particles.min.js"></script>
    <script src="./frontend/vendors/flickity/flickity.pkgd.min.js"></script>
    <script src="./frontend/vendors/isotope/isotope.pkgd.min.js"></script>
    <script src="./frontend/vendors/isotope/packery-mode.pkgd.min.js"></script>
    <script src="./frontend/vendors/flickity/flickity-fade.min.js"></script>
    <script src="./frontend/js/liquid-gdpr.min.js"></script>
    <script src="./frontend/js/theme.min.js"></script>
    <script src="./frontend/js/liquid-ajax-contact-form.min.js"></script>
  </body>
</html>
